...
#ifndef _GxEPD2_0154_Z98c_H_
#define _GxEPD2_0154_Z98c_H_

#include "GxEPD2_EPD.h"

class GxEPD2_0154_Z98c : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    // constructor
    GxEPD2_0154_Z98c(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
